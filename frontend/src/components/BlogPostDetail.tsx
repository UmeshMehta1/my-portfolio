      ...
      >
        ...
        <div className="container mx-auto px-6 relative z-10">
          ...
          >
            ...
            {/* Header */}
            <header className="mb-10 bg-gradient-to-r from-emerald-50 to-green-50 dark:from-gray-800 dark:to-gray-900 rounded-xl p-8 border border-emerald-100 dark:border-gray-700">
              <div className="flex flex-wrap items-center gap-3 mb-4 text-sm text-gray-600 dark:text-gray-400">
                <span className="px-4 py-1.5 bg-emerald-600 text-white rounded-full text-xs font-semibold shadow-sm">
                  {post.category}
                </span>
              ...
              <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600 dark:text-gray-400 pt-4 border-t border-emerald-200 dark:border-gray-700">
            ...
            {/* Featured Image */}
            {post.imageUrl && (
              <div className="mb-10 rounded-xl overflow-hidden shadow-xl border border-gray-200 dark:border-gray-700">
                <img
                  src={post.imageUrl}
            ...
            <div className="mt-12 space-y-8">
                ...
                <div className="bg-gray-50 dark:bg-gray-800/50 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {post.tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-4 py-2 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-800 dark:text-emerald-300 rounded-lg text-sm font-medium hover:bg-emerald-200 dark:hover:bg-emerald-900/50 transition-colors cursor-default"
                      >
                        #{tag}
                      </span>
                    ))}
              ...
              {/* Share Section */}
              <div className="bg-gradient-to-r from-emerald-50 to-green-50 dark:from-gray-800 dark:to-gray-900 rounded-xl p-6 border border-emerald-100 dark:border-gray-700">
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
                  <svg className="w-5 h-5 text-emerald-600 dark:text-emerald-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-[#1DA1F2] text-white rounded-lg hover:bg-[#1a8cd8] transition-colors font-medium shadow-sm"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-2 px-6 py-3 bg-[#0077b5] text-white rounded-lg hover:bg-[#006399] transition-colors font-medium shadow-sm"
                  >
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
